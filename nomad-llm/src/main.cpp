...
int main(int argc, char *argv[])
{
    ...
    QGuiApplication::setOrganizationName("Nomad");
    QGuiApplication::setOrganizationDomain("nomad-llm.local");
    QGuiApplication::setApplicationName("Nomad LLM");
    QGuiApplication::setApplicationVersion("1.0.0");

    QGuiApplication app(argc, argv);

    // Single instance check
    QSharedMemory sharedMemory("NomadLLMSingleInstance");
    ...
    app.setWindowIcon(QIcon(":/Nomad/nomad.svg"));
    ...
    const QUrl url(u"qrc:/Nomad/qml/main.qml"_qs);
